...
import wg.application.enumeration.SolarTerms;

import java.util.Calendar;

import static java.lang.Math.PI;
import static wg.application.util.CalendarUtil.fromJulianDate;
import static wg.application.util.CalendarUtil.toJulianDate;
import static wg.application.util.MathUtil.modPi;
import static wg.application.util.MathUtil.newtonIteration;
import static wg.application.util.Vsop87dEarthUtil.getEarthEclipticLongitudeForSun;
