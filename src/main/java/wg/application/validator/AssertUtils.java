...
import com.sevenme.common.exception.ErrorCode;
import com.sevenme.common.exception.SevenmeException;
...
public class AssertUtils {
    public static void isBlank(String str, String message) {
        if (org.apache.commons.lang.StringUtils.isBlank(str)) {
            throw new SevenmeException(message);
        }
    }
    ...
    public static void isBlank(String str, Integer code, String... params) {
        if (code == null) {
            throw new SevenmeException(ErrorCode.NOT_NULL, "code");
        }

        if (StringUtils.isBlank(str)) {
            throw new SevenmeException(code, params);
        }
    }
