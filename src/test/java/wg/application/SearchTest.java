...
/************************************************************************
 * @author: wg
 * @description: 根据ip 查 所属地 -- 测试
 * @createTime: 14:30 2022/8/9
 * @updateTime: 14:30 2022/8/9
 ************************************************************************/
public class SearchTest {
    ...
    public static void searchTest(String[] args) throws IOException {
        String dbPath = "src/main/resources/city/ip2region.xdb", cachePolicy = "vectorIndex";
        for (final String arg : args) {
            ...
            String key = arg.substring(2, sIdx);
